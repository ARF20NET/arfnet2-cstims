                ...
                <div class="col8">
                    ...
                    if (isset($_GET["edit"])) {
                        ...
                        echo "<div class=\"form\"><h3>Edit order ".$order["id"]."</h3><form action=\"".$_SERVER['SCRIPT_NAME']."\" method=\"post\">\n"
                            ...
                            ."<label>Status</label><br><select name=\"status\"><option value=\"setting up\" ".($order["status"] == "setting up" ? "selected" : "").">setting up</option><option value=\"active\" ".($order["status"] == "active" ? "selected" : "").">active</option><option value=\"inactive\" ".($order["status"] == "inactive" ? "selected" : "").">inactive</option></select><br>\n"
